...
import ReplyInsert from "@/components/community/Detail/ReplyInsert";
import ReplyList from "@/components/community/Detail/ReplyList";
...
const CommunityDetail = ({ params }: { params: { id: string } }) => {
  ...
  const deleteItem = async () => {
    ...
    if (result) {
      await deleteDoc(doc(db, "community", params.id));
